...
function (
    ...
    dt.dataTable({
        ...
        "columnDefs": [
            ...
            {"className": "text-center", "targets": [0, 3, 4, 5, 6, 7, 8, 8, 9, 10]},
            { 
                "targets": [0],
    ...
    $("#email-btn").on( "click", function (e) {
        e.stopPropagation();
        e.preventDefault();
        dt.find("thead th:nth-child(8), thead th:nth-child(9), thead th:nth-child(10), thead th:nth-child(11), tbody td:nth-child(8), tbody td:nth-child(9), tbody td:nth-child(10), tbody td:nth-child(11), tfoot th:nth-child(8), tfoot th:nth-child(9), tfoot th:nth-child(10), tfoot th:nth-child(11)").addClass("hide-in-mail");
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Customer List", title:"Customer List", html: thehtml});
    });
