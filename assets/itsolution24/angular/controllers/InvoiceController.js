...
function (
    ...
    $("#invoice-invoice-list").dataTable({
        ...
        "dom": "lfBrtip",
        "serverSide": true,
        "ajax": API_URL + "/_inc/invoice.php?from="+$from+"&to="+$to+"&type="+$type,
        "fixedHeader": true,
        "order": [[ 0, "desc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "columnDefs": [
            {"targets": [1, 7, 8, 9, 10, 11, 12], "orderable": false},
            {"className": "text-center", "targets": [7, 8, 9, 10, 11, 12]},
        ...
        "buttons": [
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Invoice List",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6, 7 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Invoice List", title:"Invoice List", html: thehtml});
    });
}]);